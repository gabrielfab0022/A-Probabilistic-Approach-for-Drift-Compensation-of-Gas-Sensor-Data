...
for i in range(16):
    ...
    for d in dimensions:
        for lamb in lambdas:
            ...
            deep_coral.fit(train_data, train_output_onehot, verbose=0)
            
            x_train = encoder_network.predict(train_data, verbose=0)
            x_val = encoder_network.predict(val_data, verbose=0)
